...
Items still to complete for authentication:

- Configure Resend for real email delivery.
- Remove development-only OTP values from API responses after email delivery is working.
